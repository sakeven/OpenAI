...
//        switch generated {
//            case .outputMessage(<#T##Components.Schemas.OutputMessage#>)
//        }
...
//        } else if let value = generated.value13 {
//            self = .applyPatchToolCall(value)
//        } else if let value = generated.value14 {
//            self = .applyPatchToolCallOutput(value)
//        } else if let value = generated.value15 {
//            self = .mcpToolCall(value)
//        } else if let value = generated.value16 {
//            self = .mcpListTools(value)
//        } else if let value = generated.value17 {
//            self = .mcpApprovalRequest(value)
//        } else if let value = generated.value18 {
